...
import com.github.cloudyrock.mongock.integrationtests.changelogs.empty.EmptyChangeLog;
import com.github.cloudyrock.mongock.integrationtests.util.Constants;
import com.github.cloudyrock.mongock.integrationtests.util.LegacyMigrationUtils;
...
class RunnerLegacyMigrationITest extends ApplicationRunnerTestBase {
    ...
    void shouldNotDuplicateLegacyChangeLogs_IfRunAlways_WhenLegacyMigrationReapplied(String mongoVersion) throws Exception {
        ...
        // then
        LegacyMigrationUtils.checkLegacyMigration(mongoTemplate.getDb().getCollection(Constants.CHANGELOG_COLLECTION_NAME), true, 2);
    }
...
//                : MongockSync4LegacyMigrationChangeLog.class.getPackage().getName();
        ...
        MongockSpringbootV2_2.MongockApplicationRunner runner = getBasicBuilder(EmptyChangeLog.class.getPackage().getName())
